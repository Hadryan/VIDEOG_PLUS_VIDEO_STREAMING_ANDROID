...
public class Movie extends Fragment {
    ...
    private void getMovie(int pageNumber){
        if(utility.isNetworkAvailable()) {
            Call<ContentResponse> call = apiInterface.getMovie(context.getString(R.string.authorization_key), utility.getMsisdn(), "", pageNumber, getResources().getInteger(R.integer.data_size));
