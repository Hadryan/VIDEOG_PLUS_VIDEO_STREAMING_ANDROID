...
public class Video extends Fragment {
    ...
    private void getVideoSong(int pageNumber){
        if(utility.isNetworkAvailable()) {
            Call<ContentResponse> call = apiInterface.getVideoSong(context.getString(R.string.authorization_key), utility.getMsisdn(), "", pageNumber, getResources().getInteger(R.integer.data_size));
