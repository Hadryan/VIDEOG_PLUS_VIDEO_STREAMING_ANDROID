 ...
 */
public interface GhooriApiInterface {

    @POST("vg/subscriptionstatus")
    Call<ResponseBody> viewBkashStatus(@Header("Authorization") String authorization, @Body RequestBody jsonObject);

    @POST("subscription/vg/30")
    Call<ResponseBody> activateBkash(@Header("Authorization") String authorization, @Body RequestBody jsonObject);

    @POST("unsubscribe/vg")
    Call<ResponseBody> deactivateBkash(@Header("Authorization") String authorization, @Body RequestBody jsonObject);
